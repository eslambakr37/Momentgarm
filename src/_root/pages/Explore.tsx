...
const Explore = () => {
  ...
  const { data: posts, isPending: isLoadingPosts, fetchNextPage, hasNextPage } = useGetPosts();
  ...
  if (isSearchFetching || isLoadingPosts) {
    return (
    ...
    <div className="explore-container">
      <div className="explore-inner_container">
        ...
        <div className="flex gap-1 px-4 w-full rounded-lg bg-dark-4">
          ...
          <Input type="text"
            placeholder="Search"
            className="explore-search" value={searchValue}
